...
posCorrelPosition=1
neuCorrelPosition=2
pickupMethodFlag=posCorrelPosition
if pMethod == 'negative':
    pickupMethodFlag=negCorrelPosition
elif pMethod == 'neutral':
    pickupMethodFlag=neuCorrelPosition
else:
    pickupMethodFlag=posCorrelPosition
...
if len(corrRank) > 0:
    ...
    signalData=ml.computeDecisionTreeSignal(_df,corrRank ,pNumSpan,pNumRank,pickupMethodFlag,supervisedData, 10, 20, pDirection)
